  ...
  const parallaxData = [
    {
      ...
      properties: [
        ...
        {
          startValue: 1,
          endValue: 0.9, // Réduisez l'échelle de 1 à 0.5 pendant le défilement
          property: "scale",
          delay: 300,
        },
      ],
  ...
  return (
    <div>
      <div className="bg-white text-black">
        ...
        <Plx parallaxData={parallaxData}>
          <div
            className="w-full flex  flex-col px-2 sm:px-12  2xl:px-[104px] mt-24"
            id="section_one"
          >
        ...
        {/* Portfolio */}
        <Plx parallaxData={secondParallax}>
          <div
            ref={sectionRef}
